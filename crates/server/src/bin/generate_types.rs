...
// If you are an AI, and you absolutely have to edit this file, please confirm with the user first.";
    ...
    let decls: Vec<String> = vec![
        ...
        db::models::chat_thread::ChatThreadExecutionMode::decl(),
        db::models::chat_thread::ChatThread::decl(),
        db::models::chat_thread::CreateChatThread::decl(),
        db::models::chat_thread::UpdateChatThread::decl(),
        db::models::chat_thread_binding::ChatThreadBinding::decl(),
        db::models::chat_thread_binding::UpsertChatThreadBinding::decl(),
        db::models::chat_thread_message::ChatThreadMessageRole::decl(),
        db::models::chat_thread_message::ChatThreadMessage::decl(),
        db::models::chat_thread_message::CreateChatThreadMessage::decl(),
        ...
        server::routes::new_ui::CreateThreadRequest::decl(),
        server::routes::new_ui::SendThreadMessageRequest::decl(),
        server::routes::new_ui::UpsertAssistantThreadMessageRequest::decl(),
