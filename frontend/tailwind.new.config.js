  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        // Gruvbox Baby theme colors
        gb: {
          dark0: "var(--gb-dark0)",
          dark: "var(--gb-dark)",
          'bg-dark': "var(--gb-bg-dark)",
          bg: "var(--gb-bg)",
          'bg-light': "var(--gb-bg-light)",
          fg: "var(--gb-fg)",
          gray: "var(--gb-gray)",
          'medium-gray': "var(--gb-medium-gray)",
          comment: "var(--gb-comment)",
          'error-red': "var(--gb-error-red)",
          red: "var(--gb-red)",
          orange: "var(--gb-orange)",
          'bright-yellow': "var(--gb-bright-yellow)",
          'soft-yellow': "var(--gb-soft-yellow)",
          pink: "var(--gb-pink)",
          magenta: "var(--gb-magenta)",
          'soft-green': "var(--gb-soft-green)",
          'forest-green': "var(--gb-forest-green)",
          'clean-green': "var(--gb-clean-green)",
          'blue-gray': "var(--gb-blue-gray)",
          'dark-gray': "var(--gb-dark-gray)",
          'light-blue': "var(--gb-light-blue)",
        },
      },
      borderColor: {
